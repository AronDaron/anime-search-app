    ...
    return (
        <div className="view-container fade-in">
            <div className="view-header">
                <h2 className="view-title">Sezony <span className="neon-text-cyan">Anime</span></h2>
            </div>

            <div className="filters-container glass-panel" style={{ padding: '1.5rem', marginBottom: '2rem', borderRadius: '12px', display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    {SEASONS.map(season => (
                        <button
                            ...
                            style={{
                                ...
                                background: selectedSeason === season.value ? 'rgba(0, 255, 255, 0.15)' : 'transparent',
                                color: selectedSeason === season.value ? 'var(--neon-cyan)' : 'var(--text-secondary)',
                                cursor: 'pointer',
                ...
                <>
                    {results.length === 0 ? (
                        <div className="empty-state">
                            <p>Nie odnaleziono anime dla {SEASONS.find(s => s.value === selectedSeason)?.label} {selectedYear}.</p>
                        </div>
                    ) : (
