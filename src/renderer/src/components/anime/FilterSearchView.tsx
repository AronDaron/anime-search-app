        ...
        <div className="filter-search-layout fade-in">
            ...
            <main className="filter-results-area">
                <div className="filter-results-header">
                    <h2>Wyniki Wyszukiwania {results.length > 0 && <span style={{ fontSize: '1rem', color: '#888' }}>({results.length})</span>}</h2>
                </div>
                    ...
                    <>
                        {!hasSearched ? (
                            <div className="empty-state">
                                ...
                                <p>Skorzystaj z panelu po lewej stronie, aby precyzyjniej przeglądać tysiące tytułów z bazy.</p>
                            </div>
                        ) : results.length === 0 ? (
                            <div className="empty-state">
                                <h3>Brak wyników</h3>
                                <p>Nie znaleziono anime spełniającego wybrane kryteria wyszukiwania. Spróbuj złagodzić filtry.</p>
                            </div>
                        ) : (
