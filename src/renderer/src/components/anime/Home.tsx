    ...
    <div className="home-layout fade-in">
      ...
      <div className="home-main-content">
        <div className="view-header">
          <h2 className="view-title">
            Trendujące <span className="neon-text-cyan">(30 Dni)</span>
          </h2>
        </div>
      ...
      <div className="home-sidebar">
        ...
        >
          ...
          <h2 className="view-title" style={{ fontSize: '1.4rem' }}>
            Kalendarz <span className="neon-text-purple">Premier</span>
          </h2>
        </div>
