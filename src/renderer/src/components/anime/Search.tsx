        ...
        const fetchResults = async () => {
            ...
            try {
                ...
                if (isAiMode) {
                    ...
                    if (!apiKey) {
                        alert("Brak klucza API. Ustal zmienną VITE_OPENROUTER_KEY w pliku .env w korzeniu projektu.");
                        setLoading(false);
                        return;
                    }
                    ...
                    fetchedResults = resolved.filter(r => r.Page.media.length > 0).map(r => r.Page.media[0]);
